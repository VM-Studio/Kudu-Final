...
export const metadata: Metadata = {
  title: "Hornos | KUDU",
  description:
    "Línea Hornos KUDU. Diseño moderno, seguridad y performance para tu cocina.",
};

export default function HornosPage() {
  const line = LINES.find((l) => l.slug === "hornos");

  if (!line) {
    return (
      <main className="mx-auto max-w-6xl px-5 py-16">
        <h1 className="text-3xl font-bold text-[#111]">Hornos</h1>
